...
namespace Server.Services.Foundation.OrdreMedicalService
{
    public partial class OrdreMedicalService
    {
        ...
        public delegate Task<MedicalFileArchivePatientDto> ReturningFunctionMedicalFileArchivePatient();
        public delegate Task<List<MedicalAdviceDoctorDto>> ReturningFunctionMedicalAdviceDoctor();


        public async Task<List<MedicalAdviceDoctorDto>> TryCatch__(ReturningFunctionMedicalAdviceDoctor returningFunctionMedicalAdviceDoctor)
        {
            try
            {
                return await returningFunctionMedicalAdviceDoctor();
            }
        ...
        public async Task<MedicalFileArchivePatientDto> _TryCatch_(ReturningFunctionMedicalFileArchivePatient returningFunctionMedicalFileArchivePatient)
        {
            try
            {
                return await returningFunctionMedicalFileArchivePatient();
            }
            catch (ArgumentNullException Ex)
            {
                throw new ValidationException(Ex);
