...
namespace Server.Migrations
{
    ...
    [Migration("20230623213309_migration23")]
            ...
            modelBuilder.Entity("Server.Models.UserAccount.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "df3d7fbe-24fd-4eac-bd26-6d18d35616b4",
                            Name = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("2b102f8f-079c-4ae1-b093-487ba70cf183"),
                            ConcurrencyStamp = "1723d1ef-677b-47e4-8517-e84e2c39766f",
                            Name = "PATIENT"
                        },
                        new
                        {
                            Id = new Guid("0d518584-64a4-424b-b011-7283083394b8"),
                            ConcurrencyStamp = "facd168b-c0e1-4852-97c4-ad4c7a949457",
                            Name = "SECRITAIRE"
                        },
                        new
                        {
                            Id = new Guid("14e8987f-77b0-44a9-a641-6c6779b9564c"),
                            ConcurrencyStamp = "4549bbec-711d-41c1-8647-6d0879bde438",
                            Name = "MEDECIN"
                        },
                        new
                        {
                            Id = new Guid("03d2395f-a472-4a41-b95f-45828d5f8af4"),
                            ConcurrencyStamp = "22f1ffdd-5b39-49bf-9bc3-f38e80ec64e7",
                            Name = "RADIOLOGUE"
                        },
                        new
                        {
                            Id = new Guid("0916f1e5-ff87-4d4f-89b2-d6dbb922027e"),
                            ConcurrencyStamp = "86f7b95b-bc0f-4991-8aef-26ef3e876373",
                            Name = "PHARMACIEN"
                        },
                        new
                        {
                            Id = new Guid("232d07c5-711e-4802-a048-f2f73804ea40"),
                            ConcurrencyStamp = "0686076d-2d7d-4fa5-a7a1-faa7571d9cd4",
                            Name = "ANALYSE"
                        });
                });
            ...
            modelBuilder.Entity("Server.Models.fileMedical.fileMedicals", b =>
                {
                    ...
                    b.HasIndex("MedicalIdentification")
                        .IsUnique();
